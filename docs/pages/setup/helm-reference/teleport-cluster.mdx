...
| - | - |
| ❌ | See [Using DynamoDB](../reference/backends.mdx#dynamodb) and [Using Amazon S3](../../../setup/reference/backends.mdx#s3) for details |
...
| Can be used in `custom` mode? | `teleport.yaml` equivalent |
| - | - |
| ❌ | See [Using Firestore](../reference/backends.mdx#dynamodb) and [Using GCS](../../../setup/reference/backends.mdx#gcs) for details |
