...
See the [high availability section of our Helm chart reference](../helm-deployments/teleport-cluster.mdx#highavailability) for more details on high availability.
